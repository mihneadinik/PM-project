...
#define WIDE_PIN 6
#define NARROW_PIN 7
#define REVERSE_TRIGGER_PIN PD3
#define SENSORS_TRIGGER_PIN PD4
...
const uint16_t SENSORS_OVERFLOWS = 625; // number of overflows on timer2 with 1/1024 prescaler to count 10 sec
